...
sec=$(cat ~/.config/daroch/settings/wallpaper-automation.sh)
...
if [ ! -f ~/.config/daroch/cache/wallpaper-automation ]; then
    touch ~/.config/daroch/cache/wallpaper-automation
    ...
    rm ~/.config/daroch/cache/wallpaper-automation
